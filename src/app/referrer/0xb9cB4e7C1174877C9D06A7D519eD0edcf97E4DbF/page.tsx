//<p>ผู้แนะนำ: pichitchaipum@gmail.com</p>
//<p>0xb9cB4e7C1174877C9D06A7D519eD0edcf97E4DbF</p>
//tokenId: 9n
"use client";
    ...
    return (
        <div style={{
            ...
            <div className="flex flex-col gap-4 md:gap-8">
                ...
                <img  className="h-56 w-56 m-6" src="https://i.seadn.io/s/raw/files/45b1d8e414d181f25932da532ab5a3ad.png?auto=format&dpr=1&w=1000" alt="" />
                {/* <NFTMetadata /> */}
                </a>
            </div>
