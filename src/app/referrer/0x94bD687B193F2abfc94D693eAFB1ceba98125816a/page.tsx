//<p>ผู้แนะนำ: nkara4310@gmail.com</p>
//<p>0x94bD687B193F2abfc94D693eAFB1ceba98125816</p>
//tokenId: 10n
"use client";
...
const WalletBalances: React.FC<walletAddresssProps> = ({ walletAddress }) => {
    ...
    return (
        <div style={{
            ...
            <div className="flex flex-col gap-4 md:gap-8">
                <a target="_blank" href="https://opensea.io/assets/matic/0x2a61627c3457ccea35482cadec698c7360ffb9f2/10">
                <img  className="h-56 w-56 m-6" src="https://i.seadn.io/s/raw/files/2d9063503a0b456cf4a174934f57858d.png?auto=format&dpr=1&w=1000" alt="" />
                {/* <NFTMetadata /> */}
                </a>
            </div>
